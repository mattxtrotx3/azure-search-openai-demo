...
var chatGpt = {
  modelName: !empty(chatGptModelName) ? chatGptModelName : 'gpt-5.2-chat'
  deploymentName: !empty(chatGptDeploymentName) ? chatGptDeploymentName : 'gpt-5.2-chat'
  deploymentVersion: !empty(chatGptDeploymentVersion) ? chatGptDeploymentVersion : '2025-12-11'
